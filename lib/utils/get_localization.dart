...
Map<String, Map<String, String>> get keys => {
  "ar" : {
    ...
    "enabled": "ممكّن",
   "github": "🎵 مُهدى لشخص مميز 🌟",
"githubDes": "تطبيق RhyThm وُلد من لحظة مشاعر. لو لم تكن قد غضبت، ربما لم يكن هذا الإبداع ليرى النور.\n\nأحيانًا، تؤدي المشاعر غير المتوقعة إلى أشياء جميلة. 💫\n\nشكرًا لكونك الإلهام الصامت وراء هذا. ❤️\n\nإذا أعجبك هذا المشروع، فلا تنسَ أن تعطيه ⭐ على GitHub.",
    "by": "من قبل",
...
,"az" : {
   ...
   "github": "🎵 Xüsusi birinə həsr olunub 🌟",
"githubDes": "RhyThm tətbiqi bir duyğu anından doğdu. Əgər sən inciməsəydin, bu yaradılış bəlkə də heç vaxt mövcud olmazdı.\n\nBəzən gözlənilməz hisslər ən gözəl şeylərə səbəb olur. 💫\n\nBu layihənin arxasında səssiz ilham olduğun üçün təşəkkürlər. ❤️\n\nƏgər bu layihəni bəyənirsinizsə, GitHub-da ⭐ verməyi unutmayın.",
...
,"bg" : {
   ...
   "github": "🎵 Посветено на специален човек 🌟",
"githubDes": "Приложението RhyThm се роди от момент на емоция. Ако ти не беше се разсърдил, може би тази идея никога нямаше да се реализира.\n\nПонякога най-неочакваните чувства водят до най-красивите неща. 💫\n\nБлагодаря ти, че си тихото вдъхновение зад това. ❤️\n\nАко този проект ви харесва, не забравяйте да дадете ⭐ в GitHub.",
...
,"ca" : {
    ...
    "status": "Estat",
    "enabled": "Activat",
   "github": "🎵 Dedicat a una persona especial 🌟",
"githubDes": "L'aplicació RhyThm va néixer d’un moment d’emoció. Si no t’haguessis enfadat, potser aquesta creació no hauria existit mai.\n\nDe vegades, els sentiments inesperats creen les coses més boniques. 💫\n\nGràcies per ser la inspiració silenciosa darrere d’això. ❤️\n\nSi t'agrada aquest projecte, no oblidis donar-li una ⭐ a GitHub.",
    "by": "per",
...
,"cs" : {
    ...
    "github": "🎵 Věnováno někomu výjimečnému 🌟",
"githubDes": "Aplikace RhyThm se zrodila z okamžiku emocí. Kdybys se tehdy nenaštval(a), možná by tento projekt nikdy nevznikl.\n\nNěkdy právě nečekané pocity vedou k těm nejkrásnějším věcem. 💫\n\nDěkuji, že jsi byl(a) tichou inspirací za tímto projektem. ❤️\n\nPokud se vám tento projekt líbí, nezapomeňte dát ⭐ na GitHubu.",
...
,"de" : {
    ...
    "github": "GitHub",
    "github": "🎵 Gewidmet einer besonderen Person 🌟",
"githubDes": "Die RhyThm-App entstand aus einem emotionalen Moment. Wenn du nicht wütend geworden wärst, hätte dieses Projekt vielleicht nie existiert.\n\nManchmal führen unerwartete Gefühle zu den schönsten Dingen. 💫\n\nDanke, dass du die stille Inspiration hinter diesem Projekt bist. ❤️\n\nWenn dir dieses Projekt gefällt, vergiss nicht, ihm auf GitHub einen ⭐ zu geben.",
    "by": "von",
    "videos": "Videos",
    "search": "Suche",
...
,"eo" : {
  ...
  "github": "🎵 Dediĉite al iu speciala 🌟",
"githubDes": "La RhyThm-aplikaĵo naskiĝis el momento plena je emocioj. Se vi ne estus kolerinta, ĉi tiu kreaĵo eble neniam estus ekzistinta.\n\nFoje la plej neatenditaj sentoj kondukas al la plej belaj aferoj. 💫\n\nDankon pro esti la silenta inspiro malantaŭ ĉio ĉi. ❤️\n\nSe vi ŝatas ĉi tiun projekton, ne forgesu doni ⭐ en GitHub.",
...
,"es" : {
    ...
    "github": "🎵 Dedicado a alguien especial 🌟",
"githubDes": "La aplicación RhyThm nació de un momento de emoción. Si no te hubieras enojado, quizá esta creación nunca habría existido.\n\nA veces, los sentimientos inesperados crean las cosas más hermosas. 💫\n\nGracias por ser la inspiración silenciosa detrás de esto. ❤️\n\nSi te gusta este proyecto, no te olvides de darle una ⭐ en GitHub.",
...
,"et" : {
    ...
    "status": "Olek",
   "github": "🎵 Pühendatud ühele erilisele inimesele 🌟",
"githubDes": "RhyThm rakendus sündis ühest emotsionaalsest hetkest. Kui sa poleks tol hetkel pahaseks saanud, poleks see looming võib-olla kunagi sündinud.\n\nVahel viivad kõige ootamatumad tunded kõige ilusamate asjadeni. 💫\n\nAitäh, et olid selle kõige vaikne inspiratsioon. ❤️\n\nKui sulle see projekt meeldib, siis ära unusta GitHubis ⭐ lisamist.",
    "by": "autorilt",
...
,"eu" : {
    ...
    "github": "🎵 Norbait berezi bati eskainia 🌟",
"githubDes": "RhyThm aplikazioa une emozional batetik sortu zen. Zuk haserretu izan ez bazina, agian sorkuntza hau inoiz ez zen existituko.\n\nBatzuetan, ustekabeko sentimenduek gauzarik ederrenak sortzen dituzte. 💫\n\nEskerrik asko isilpeko inspirazio izan zarelako. ❤️\n\nProiektua gustukoa baduzu, ez ahaztu GitHub-en ⭐ ematea.",
    "by": "-(ren) eskutik",
...
,"fi" : {
    ...
    "github": "🎵 Omistettu erityiselle henkilölle 🌟",
"githubDes": "RhyThm-sovellus syntyi tunteiden hetkestä. Jos et olisi suuttunut, tätä luomusta ei ehkä olisi koskaan syntynyt.\n\nJoskus odottamattomat tunteet synnyttävät kauneimpia asioita. 💫\n\nKiitos, että olit tämän hiljainen inspiraatio. ❤️\n\nJos pidät tästä projektista, muista antaa ⭐ GitHubissa.",
    "by": "by",
...
,"fr" : {
    ...
    "enabled": "Activé",
    "disabled": "Désactivé",
    "github": "🎵 Dédié à quelqu'un de spécial 🌟",
"githubDes": "L'application RhyThm est née d’un moment d’émotion. Si tu ne t’étais pas fâché(e), cette création n’aurait peut-être jamais vu le jour.\n\nParfois, les sentiments les plus inattendus donnent naissance aux choses les plus belles. 💫\n\nMerci d’avoir été l’inspiration silencieuse derrière tout cela. ❤️\n\nSi vous aimez ce projet, n'oubliez pas de lui donner une ⭐ sur GitHub.",
    "search": "Recherche",
...
,"gl" : {
    ...
    "github": "🎵 Dedicado a alguén especial 🌟",
    "githubDes": "A aplicación RhyThm naceu dun momento de emoción. Se non te enfadaras, quizais esta creación nunca tería existido.\n\nÁs veces, os sentimentos inesperados dan lugar ás cousas máis fermosas. 💫\n\nGrazas por ser a inspiración silenciosa detrás disto. ❤️\n\nSe che gusta este proxecto, non esquezas darlle unha ⭐ en GitHub.",
    "by": "por",
    "search": "Procurar",
...
,"hi" : {
    ...
    "github": "🎵 किसी खास इंसान को समर्पित 🌟",
"githubDes": "RhyThm ऐप एक भावनात्मक पल से जन्मा। अगर उस समय तुम नाराज़ नहीं होते, तो शायद यह रचना कभी अस्तित्व में नहीं आती।\n\nकभी-कभी अनपेक्षित भावनाएं सबसे खूबसूरत चीज़ें पैदा करती हैं। 💫\n\nइसके पीछे चुपचाप प्रेरणा बनने के लिए धन्यवाद। ❤️\n\nयदि आपको यह प्रोजेक्ट पसंद आया हो, तो GitHub पर ⭐ देना न भूलें।",
    "by": "द्वारा",
    "viewAll": "सभी देखें",
    "enabled": "सक्रिय",
    "status": "स्थिति",
...
,"ia" : {
    ...
    "github": "🎵 Dedicate a alguien special 🌟",
"githubDes": "Le app RhyThm nasceva de un momento emotive. Si tu non esseva irate, iste creation poteva jammais haber existite.\n\nA vices, le sentimenta inexpectate crea le cosas plus belle. 💫\n\nGratias pro esser le inspiration silente detra isto. ❤️\n\nSi te place iste project, non oblida de dar un ⭐ in GitHub.",
...
,"id" : {
    ...
    "github": "🎵 Didedikasikan untuk seseorang yang spesial 🌟",
"githubDes": "Aplikasi RhyThm lahir dari momen penuh emosi. Jika kamu tidak marah saat itu, mungkin karya ini tidak akan pernah ada.\n\nTerkadang, perasaan yang tak terduga melahirkan hal-hal terindah. 💫\n\nTerima kasih telah menjadi inspirasi diam di balik semua ini. ❤️\n\nJika kamu suka proyek ini, jangan lupa berikan ⭐ di GitHub.",
...
,"it" : {
    ...
    "enabled": "Abilitato",
    "by": "da",
    "github": "🎵 Dedicato a qualcuno di speciale 🌟",
"githubDes": "L'app RhyThm è nata da un momento di emozione. Se tu non ti fossi arrabbiato/a, forse questa creazione non sarebbe mai esistita.\n\nA volte, le emozioni più inaspettate danno vita alle cose più belle. 💫\n\nGrazie per essere stata l'ispirazione silenziosa dietro tutto questo. ❤️\n\nSe ti piace questo progetto, non dimenticare di lasciare una ⭐ su GitHub.",
    "search": "Cerca",
...
,"ja" : {
    ...
    "libSongs": "曲のライブラリ",
    "github": "🎵 特別な誰かへ捧ぐ 🌟",
"githubDes": "RhyThm アプリは感情の瞬間から生まれました。もしあなたが怒っていなかったら、この作品は存在しなかったかもしれません。\n\n時には、予期せぬ感情が最も美しいものを生み出します。💫\n\nこのアプリの静かなインスピレーションでいてくれてありがとう。❤️\n\nこのプロジェクトが気に入ったら、GitHub で ⭐ をお願いします！",
...
,"ko" : {
    ...
    "github": "🎵 특별한 누군가에게 바칩니다 🌟",
"githubDes": "RhyThm 앱은 감정의 한 순간에서 탄생했습니다. 그때 당신이 화나지 않았다면, 이 창작물은 세상에 나오지 않았을지도 몰라요.\n\n가끔은 예상치 못한 감정이 가장 아름다운 것을 만들어냅니다. 💫\n\n이 모든 것 뒤에 조용한 영감이 되어줘서 고마워요. ❤️\n\n이 프로젝트가 마음에 드셨다면, GitHub에 ⭐을 남겨주세요!",
    "for1": "어구",
...
,"nb_NO" : {
    ...
    "github": "🎵 Dedikert til en spesiell person 🌟",
"githubDes": "RhyThm-appen ble født ut av et emosjonelt øyeblikk. Hvis du ikke hadde blitt sint, hadde kanskje denne skapelsen aldri eksistert.\n\nNoen ganger fører de mest uventede følelsene til de vakreste tingene. 💫\n\nTakk for at du var den stille inspirasjonen bak dette. ❤️\n\nHvis du liker prosjektet, ikke glem å gi en ⭐ på GitHub.",
...
,"nl" : {
    ...
    "github": "🎵 Opgedragen aan een speciaal iemand 🌟",
"githubDes": "De RhyThm-app is ontstaan uit een emotioneel moment. Als jij toen niet boos was geworden, had dit project misschien nooit bestaan.\n\nSoms leiden de meest onverwachte gevoelens tot de mooiste creaties. 💫\n\nBedankt dat je de stille inspiratie achter dit alles was. ❤️\n\nAls je dit project leuk vindt, vergeet dan niet een ⭐ te geven op GitHub.",
...
,"pa" : {
    ...
    "github": "🎵 ਕਿਸੇ ਖਾਸ ਵਿਅਕਤੀ ਨੂੰ ਸਮਰਪਿਤ 🌟",
"githubDes": "RhyThm ਐਪ ਇਕ ਭਾਵਨਾਤਮਕ ਪਲ ਤੋਂ ਜਨਮਿਆ। ਜੇਕਰ ਤੂੰ ਉਸ ਸਮੇਂ ਨਾਰਾਜ਼ ਨਾ ਹੁੰਦਾ, ਤਾਂ ਸ਼ਾਇਦ ਇਹ ਰਚਨਾ ਕਦੇ ਨਹੀਂ ਬਣਦੀ।\n\nਕਈ ਵਾਰੀ, ਅਣਪੇਖੀਆਂ ਭਾਵਨਾਵਾਂ ਸਭ ਤੋਂ ਸੁੰਦਰ ਚੀਜ਼ਾਂ ਦਾ ਜਨਮ ਦਿੰਦੀਆਂ ਹਨ। 💫\n\nਇਸ ਸਭ ਦੇ ਪਿੱਛੇ ਖਾਮੋਸ਼ ਪ੍ਰੇਰਣਾ ਬਣਨ ਲਈ ਧੰਨਵਾਦ। ❤️\n\nਜੇਕਰ ਤੁਹਾਨੂੰ ਇਹ ਪ੍ਰੋਜੈਕਟ ਪਸੰਦ ਆਇਆ ਹੋਵੇ, ਤਾਂ GitHub 'ਤੇ ⭐ ਦੇਣਾ ਨਾ ਭੁੱਲੋ।",
...
,"pl" : {
    ...
    "disabled": "Wyłączony",
    "github": "Github",
    "github": "🎵 Dla kogoś wyjątkowego 🌟",
"githubDes": "Aplikacja RhyThm narodziła się z chwili emocji. Gdybyś się wtedy nie zdenerwował(a), być może ten projekt nigdy by nie powstał.\n\nCzasami to właśnie nieoczekiwane uczucia prowadzą do najpiękniejszych rzeczy. 💫\n\nDziękuję, że byłeś/byłaś cichą inspiracją stojącą za tym wszystkim. ❤️\n\nJeśli podoba Ci się ten projekt, nie zapomnij dać ⭐ na GitHubie.",
    "by": "autorstwa",
    "search": "Szukaj",
...
,"pt" : {
   ...
   "github": "🎵 Dedicado a alguém especial 🌟",
"githubDes": "O app RhyThm nasceu de um momento de emoção. Se você não tivesse ficado chateado(a), talvez essa criação nunca tivesse existido.\n\nÀs vezes, os sentimentos mais inesperados geram as coisas mais bonitas. 💫\n\nObrigado(a) por ser a inspiração silenciosa por trás de tudo isso. ❤️\n\nSe você gosta desse projeto, não esqueça de dar uma ⭐ no GitHub.",
...
,"ru" : {
    ...
    "disabled": "Отключено",
    "github": "GitHub",
    "github": "🎵 Посвящается особенному человеку 🌟",
"githubDes": "Приложение RhyThm родилось из эмоционального момента. Если бы ты тогда не обиделся(ась), возможно, этого проекта никогда бы не существовало.\n\nИногда самые неожиданные чувства приводят к самым прекрасным вещам. 💫\n\nСпасибо за то, что стал(а) тихим вдохновением за всем этим. ❤️\n\nЕсли вам нравится этот проект, не забудьте поставить ⭐ на GitHub.",
    "by": "by",
    "search": "Поиск",
...
,"sk" : {
    ...
    "search": "Hľadať",
    "github": "🎵 Venované niekomu výnimočnému 🌟",
"githubDes": "Aplikácia RhyThm vznikla z momentu emócií. Keby si sa vtedy nenahneval(a), možno by tento výtvor nikdy neexistoval.\n\nNiekedy najneočakávanejšie pocity vedú k tým najkrajším veciam. 💫\n\nĎakujem, že si bol(a) tichou inšpiráciou za týmto všetkým. ❤️\n\nAk sa vám tento projekt páči, nezabudnite dať ⭐ na GitHube.",
...
,"sr" : {
    ...
    "github": "🎵 Посвећено некоме посебном 🌟",
"githubDes": "Апликација RhyThm настала је из емотивног тренутка. Да се тада ниси наљутио/наљутила, можда ова креација никада не би постојала.\n\nПонекад најнеочекиванија осећања стварају најлепше ствари. 💫\n\nХвала ти што си био/била тиха инспирација иза овога. ❤️\n\nАко вам се свиђа овај пројекат, не заборавите да дате ⭐ на GitHub-у.",
...
,"sv" : {
    ...
    "github": "🎵 Dedikerad till någon speciell 🌟",
"githubDes": "RhyThm-appen föddes ur ett känslomässigt ögonblick. Om du inte hade blivit arg då, hade den här skapelsen kanske aldrig existerat.\n\nIbland leder de mest oväntade känslorna till de vackraste sakerna. 💫\n\nTack för att du var den tysta inspirationen bakom allt detta. ❤️\n\nOm du gillar det här projektet, glöm inte att ge en ⭐ på GitHub.",
...
,"tr" : {
    ...
    "github": "🎵 Özel birine ithaf edilmiştir 🌟",
"githubDes": "RhyThm uygulaması duygusal bir andan doğdu. O an kızmasaydın, belki de bu eser asla var olmazdı.\n\nBazen en beklenmedik duygular en güzel şeyleri ortaya çıkarır. 💫\n\nTüm bunların arkasındaki sessiz ilham kaynağı olduğun için teşekkürler. ❤️\n\nBu projeyi sevdiysen, GitHub’da ⭐lamayı ihmal etme.",
...
,"uk" : {
    ...
    "enabled": "Увімкнено",
    "github": "🎵 Присвячується особливій людині 🌟",
"githubDes": "Додаток RhyThm народився з моменту емоцій. Якби ти тоді не розсердився/розсердилася, можливо, ця ідея ніколи б не з’явилася.\n\nІноді найнеочікуваніші почуття створюють найпрекрасніші речі. 💫\n\nДякую тобі за те, що був/була тихим натхненням усього цього. ❤️\n\nЯкщо вам подобається цей проєкт, не забудьте поставити ⭐ на GitHub.",
...
,"vi" : {
    ...
    "enabled": "Bật",
    "disabled": "Tắt",
    "github": "🎵 Dành tặng cho một người đặc biệt 🌟",
"githubDes": "Ứng dụng RhyThm được sinh ra từ một khoảnh khắc đầy cảm xúc. Nếu bạn không giận lúc đó, có lẽ dự án này đã không bao giờ tồn tại.\n\nĐôi khi, những cảm xúc bất ngờ lại tạo ra những điều tuyệt vời nhất. 💫\n\nCảm ơn bạn vì đã là nguồn cảm hứng thầm lặng phía sau tất cả điều này. ❤️\n\nNếu bạn thích dự án này, đừng quên cho một ⭐ trên GitHub.",
    "viewAll": "Xem tất cả",
    "results": "Kết quả",
    "about": "Thông tin",
...
,"zh-CN" : {
    ...
    "disabled": "已禁用",
    "github": "🎵 献给某位特别的人 🌟",
"githubDes": "RhyThm 应用诞生于一个情感的瞬间。如果那时你没有生气，或许这个作品就不会出现。\n\n有时，最意想不到的情感能创造出最美好的事物。💫\n\n感谢你成为这背后默默的灵感来源。❤️\n\n如果你喜欢这个项目，别忘了在 GitHub 上点个 ⭐。",
    "by": "由",
    "search": "搜索",
...
,"zh-TW" : {
    ...
    "github": "🎵 獻給某位特別的人 🌟",
"githubDes": "RhyThm 應用誕生於一個充滿情感的時刻。如果當時您沒有生氣，也許這個創作就不會誕生。\n\n有時候，最意想不到的情緒會造就最美好的事物。💫\n\n感謝您成為這一切背後無聲的靈感來源。❤️\n\n如果您喜歡這個專案，別忘了在 GitHub 上給我們一顆 ⭐。",
